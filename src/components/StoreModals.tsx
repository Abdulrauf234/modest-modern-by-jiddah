    ...
    <>
      ...
      {quickViewProduct && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6">
          <div className="bg-white rounded-2xl sm:rounded-3xl max-w-3xl w-full max-h-[90vh] overflow-y-auto sm:overflow-hidden shadow-2xl border border-[#D4AF37]/30 relative text-left">
            <button
              onClick={onCloseQuickView}
              className="absolute top-3 right-3 z-20 p-2 rounded-full bg-white/90 hover:bg-white text-gray-700 shadow-md transition-colors cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>

            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="relative aspect-[4/3] sm:aspect-square bg-gray-100 max-h-64 sm:max-h-none">
                <img
                ...
                {quickViewProduct.isBestSeller && (
                  <span className="absolute top-3 left-3 bg-[#D4AF37] text-white text-[10px] uppercase font-bold tracking-widest px-2.5 py-0.5 rounded-full">
                    Best Seller
                  </span>
                )}
              </div>
              ...
              <div className="p-5 sm:p-8 flex flex-col justify-between space-y-4 sm:space-y-6">
                <div>
                  ...
                  <h3 className="font-playfair text-xl sm:text-2xl font-bold text-[#2C2C2C] mt-1 mb-1.5 leading-snug">
                  ...
                  <div className="flex items-baseline space-x-3 mb-3">
                    {quickViewProduct.discountPrice ? (
                      <>
                        <span className="font-playfair text-xl sm:text-2xl font-bold text-[#2C2C2C]">
                  ...
                  <p className="text-xs text-gray-600 font-light leading-relaxed mb-3 line-clamp-3 sm:line-clamp-none">
                    {quickViewProduct.description}
                  </p>

                  <div className="text-xs space-y-1 text-gray-500 border-t border-gray-100 pt-3">
                ...
                <div className="flex space-x-3 pt-2">
                  <button
                    ...
                    className="flex-1 py-3 rounded-full bg-gradient-to-r from-[#D4AF37] to-[#AA8B22] text-white text-xs font-bold uppercase tracking-wider shadow-md hover:brightness-105 transition-all flex items-center justify-center space-x-2 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="p-3 rounded-full border border-gray-300 hover:border-[#D4AF37] text-gray-700 hover:text-red-500 transition-colors cursor-pointer"
                  >
